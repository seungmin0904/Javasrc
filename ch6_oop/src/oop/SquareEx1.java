...
public class SquareEx1 {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(Arrays.toString(squareArr)); // null로 초기화 됨

        squareArr[0] = new Square(15);
        // System.out.println("첫번째" + squareArr[0].getArea());

        squareArr[1] = new Square(7);
        // System.out.println("두번째" + squareArr[1].getArea());

        squareArr[2] = new Square(9);
        // System.out.println("세번쨰" +squareArr[2].getArea());

        squareArr[3] = new Square(8);
        // System.out.println("네번째" + squareArr[3].getArea());

        squareArr[4] = new Square(12);
        // System.out.println("다섯번째" + squareArr[4].getArea());
